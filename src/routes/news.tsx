...
export const Route = createFileRoute("/news")({
  head: () => ({ meta: [{ title: "News & Events — PV Lumens India" }] }),
  component: NewsPage,
});
    ...
    <div className="min-h-screen flex flex-col bg-white">
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center py-24">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="font-display text-4xl sm:text-5xl font-semibold text-navy-deep mb-4">News & Events</h1>
          ...
          <p className="text-slate-500 text-base max-w-md leading-relaxed">
            We're curating our latest news, events, and announcements. Check back soon.
          </p>
        </motion.div>
      </div>
      <Footer />
